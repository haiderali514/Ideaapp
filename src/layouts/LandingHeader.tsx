...
export const LandingHeader: React.FC = () => {
    ...
    const displayUser = user || { name: "hhhhhhhhh", initials: "H", email: "guest@example.com" };
        ...
        <header className="landing-header">
            ...
            <div className="landing-header-right">
                <div className="landing-header-actions">
                 ...
                 <div className="landing-header-user" ref={profileMenuRef}>
                    <button className="user-profile-btn" onClick={() => setIsProfileMenuOpen(p => !p)}>
                        <span className="user-avatar-btn">{displayUser.initials}</span>
                        <span className="username">{displayUser.name}'s IdeaSpark AI</span>
                    </button>
                    {isProfileMenuOpen && (
