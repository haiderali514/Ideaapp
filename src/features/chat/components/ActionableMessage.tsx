    ...
    return (
        <div className="actionable-message">
            <div className="actionable-message-header">
                <h4>{details.title}</h4>
                <svg xmlns="http://www.w.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </div>
            <p className="actionable-message-description">{details.description}</p>
            <div className="actionable-message-buttons">
                <button className="action-btn" onClick={() => setMainViewMode('project_preview')}>
